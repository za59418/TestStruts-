...
<html>
    ...
    <body>
        <s:form action="testAjax" id="ajaxform" name="ajaxform">
            <s:textfield name="name" id="name" label="Enter ur name"/>
            <sj:submit onBeforeTopics="subform" button="true" value="ajax" targets="ndiv"/>
        </s:form>
        ...
        <img src="<s:url action="testChart"/>" width="640" height="500"/>
